...
export default function ForwardMessageUserList() {
  ...
  return (
    <div className="flex items-start justify-between gap-3.5 flex-col w-8/12 h-fit py-6 mx-auto bg-base-100 px-12 relative shadow-[0_0_20px_rgba(255,255,255,0.15)]">
